...
namespace DigitalRubyShared
{
    ...
    public class FingersPanOrbitComponentScript : MonoBehaviour
    {
            ...
            if (OrbitXSpeed != 0.0f && yVelocity != 0.0f)
            {
                ...
                else
                {
                    ...
                    if (OrbitXMaxDegrees > 0.0f)
                    {
                        ...
                        // TODO Hack!! Artificial disabling of orbiting below the target
                        else if (newDegrees < 0f)
                        {
                            addAngle = 0f;
                        }
        ...
        protected virtual void PanGesture_Updated(GestureRecognizer gesture)
        {
